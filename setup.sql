...
insert into transactions (id, due_date, amount, bank, category, tr_type) values (1, '2015-01-01', 100, 'KB', 1, 1);
insert into transactions (id, due_date, amount, bank, category, tr_type) values (2, '2015-01-02', 200, 'KB', 2, 1);
insert into transactions (id, due_date, amount, bank, category, tr_type) values (3, '2015-01-03', 300, 'KB', 3, 1);
